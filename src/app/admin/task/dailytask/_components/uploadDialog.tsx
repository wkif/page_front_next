...
export default function UploadDialogComp({
    ...
    return <>
            ...
            <DialogContent className="max-w-screen-md">
                ...
                <div className="w-full mb-6 flex flex-col ">
                    ...
                    <div className="flex flex-row items-center mt-4">
                        <span className="mr-2">Daily Template</span>
                        <div className="grid w-full max-w-sm items-center gap-1.5">
                            <Input id="picture" type="file" onChange={(e) => selectFile(e)} />
                        </div>
                        <div>
                        </div>
                    </div>
        ...
        <XLSXPreview open={previewOpen} setOpen={setPreviewOpen} xlsxFile={file} actionFunc={actionFunc} cancelFunc={cancelFunc} />
    </>
}